...
questions_list = [] 
questions_list.append(Question('Bosnia and Herzegovina has had its name since:', '1878', '1234', '1436', '1787'))
questions_list.append(Question('Which quote is Marie Antoinette known for?', 'Let them eat cake!', 'You must not lose faith in humanity.', 'Life is like a game of cards.', 'Jewel of the Crown'))
questions_list.append(Question('What is the  capital of Canada?', 'Ottawa', 'Sarajevo', 'New York', 'Ontario'))
questions_list.append(Question('Which famous composer did Marie Antoinette meet?', 'Wolfgang Amadeus Mozart', 'Pyotr Ilyich Tchaikovsky', 'Fyodor Dostoevsky', 'Johann Sebastian Bach'))
...
def check_answer():
    ...
    if answers[0].isChecked():
        ...
        window.score +=1
        print('Statistics\n-Total questions:', window.total,  'Right answers:', window.score)
